...
public class DatabaseController {
    ...
    public static final String SELECT_TASK_SPECIFIC = "SELECT id, task, task_change_date, is_completed FROM tasks WHERE task = ?";
    ...
    public static Connection openConnection(String CONNECTION_STRING) {
    ...
    public static void setupDB(String CONNECTION_STRING) {
        try (var connection = DriverManager.getConnection(CONNECTION_STRING);
    ...
    public void getTasks(Connection connection) {
        var result = new ArrayList<TaskRecord>();

        try (var statement = connection.prepareStatement(SELECT_TASK_GLOBAL)) {
            statement.executeUpdate();
        } catch (SQLException e) {
            System.out.printf("Falha ao procurar.");
    ...
    public static void storeTask(BaseTask task, Connection connection) {
    ...
    public static void removeTask(int id, Connection connection) {
        try (var statement = connection.prepareStatement(DELETE_TASK)) {
            ...
            System.out.printf("Falha ao deletar.");
            System.out.println(e.getMessage());
        }
    }
    /*
